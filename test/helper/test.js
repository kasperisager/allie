 ...
 *   `,
 *   p => assert(text(p) === 'This is a paragraph of text')
 * );
 *
 * @param {String} html
...
export default function test(html = '', action = () => undefined) {
  ...
  function act(resolve, reject) {
    ...
    if (head.children.length !== 0) {
      context = new Element(document.documentElement);
    ...
    //
      ...
      context = new Element(body.children[0]);
